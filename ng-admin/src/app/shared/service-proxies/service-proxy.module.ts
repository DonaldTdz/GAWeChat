...
import { ActivityBanquetServiceProxy, ActivityDeliveryInfoServiceProxy, UserAnswerService, UserQuestionService, ArticleServiceProxy, ExhibitionShopServiceProxy, DemandForecastServiceProxy } from '@shared/service-proxies/marketing-service';
