...
import { ActivityBanquetServiceProxy, ActivityDeliveryInfoServiceProxy, UserAnswerService, UserQuestionService, ArticleServiceProxy, ExhibitionShopServiceProxy, QuestionnaireServiceProxy, DemandForecastServiceProxy } from '@shared/service-proxies/marketing-service';
